...
long files_so_far = 0;        /* files processed so far */
long files_total = 0;         /* files total to process */
zoff_t bytes_so_far = 0;      /* bytes processed so far */
zoff_t bytes_total = 0;       /* total bytes to process */
...
zoff_t zipbeg;                /* Starting offset of zip structures */
zoff_t cenbeg;                /* Starting offset of central directory */
zoff_t tempzn;                /* Count of bytes written to output zip file */
  ...
  zoff_t cd_start_offset = 0;       /* offset of start of cd on cd start disk */
  zoff_t cd_entries_this_disk = 0;  /* cd entries this disk */
  zoff_t total_cd_entries = 0;      /* total cd entries */
  ...
  zoff_t current_local_offset = 0;  /* offset to start of current local header */
  /* global */
