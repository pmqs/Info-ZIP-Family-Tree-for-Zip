...
local zoff_t filecompress OF((struct zlist far *z_entry, FILE *zipfile,
                           int *cmpr_method));
...
#  endif
  ...
  file_binary = -1;      /* set after first read */
 ...
 */
local zoff_t filecompress(z_entry, zipfile, cmpr_method)
