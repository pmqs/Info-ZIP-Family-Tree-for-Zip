#==========================================================================
# MMS description file for Zip, ZipNote, ZipCloak and ZipSplit    26 Jan 02
#==========================================================================
...
#  Last modified (added automatic system detection) by C. Spieler, 26-JAN-2002
#
#  To build the default MMS target
#    "Zip and the Ziputils, including help file"
...
#  (e.g.: partial builds, alternate compiler option settings, ...), you have
#  to specify your compiling environment, too. These are:
#
...
#
#  For example, to build all executables using VAX C on a VMS VAX system
#  with both VAXC and DECC installed, you could type:
#       $ MMS/MACRO=(__FORCE_VAXC__=1)/DESCR=[.VMS] default
